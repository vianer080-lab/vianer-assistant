...
export async function POST(request) {
  ...
  const speech = await fetch(OPENAI_SPEECH_URL, {
    ...
    body: JSON.stringify({
      ...
      voice: 'marin',
      input: text,
      instructions: 'Говори по-русски естественным молодым женским голосом. Тембр светлый, тёплый и современный, без манеры диктора метро. Тон живой, дружелюбный и уверенный. Темп разговорный и разборчивый, с короткими естественными паузами. Не используй низкий, хриплый, мужской или пожилой тембр.',
      response_format: 'mp3',
    }),
  });
