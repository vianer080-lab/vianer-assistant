...
export async function POST(request) {
  ...
  const speech = await fetch(OPENAI_SPEECH_URL, {
    ...
    body: JSON.stringify({
      ...
      voice: 'coral',
      input: text,
      instructions: 'Говори по-русски отчётливым молодым женским голосом, примерно 22–27 лет. Тон живой, энергичный, дружелюбный и естественный. Темп быстрый, но разборчивый. Короткие паузы. Не используй низкий, хриплый или пожилой тембр.',
      response_format: 'mp3',
    }),
  });
